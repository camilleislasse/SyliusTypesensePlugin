...
export COMPOSE_PROJECT_NAME=sylius_typesense
PLUGIN_NAME=sylius-typesense
COMPOSE=docker compose
YARN=yarn
DOCTRINE_MIGRATIONS_NAMESPACE=ACSEO\SyliusTypesense\Migrations
...
test.all: test.composer test.phpstan test.phpcs test.yaml test.schema test.twig test.container ## Run all tests in once
...
test.phpmd: ## Run PHPMD
	${COMPOSER} phpmd --exclude Migrations/* src/ ansi
